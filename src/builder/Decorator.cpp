...
template<>
std::string Decorator<std::string>::decorateLine(std::string line)
{
...
template<>
std::string Decorator<File>::decorateLine(File file)
{
...
template<>
std::string Decorator<File>::decorateBody(const std::string& body)
{
...
template<>
std::string Decorator<std::string>::decorateBody(const std::string& body)
{
   TRC_DEBUG_FUNC_ENTER(0U, "body='%s'", body.c_str());
